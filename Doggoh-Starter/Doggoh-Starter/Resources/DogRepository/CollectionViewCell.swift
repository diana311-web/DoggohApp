...
//        contentView.layer.cornerRadius = 22
    ...
    override var isSelected: Bool {
        didSet {
            ...
            containerView.backgroundColor = isSelected ?  #colorLiteral(red: 0.9549426436, green: 0.439017117, blue: 0.2413057983, alpha: 1): #colorLiteral(red: 0.8974477649, green: 0.9018339515, blue: 0.9277464747, alpha: 1)
            if(isSelected){
