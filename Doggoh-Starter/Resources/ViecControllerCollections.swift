...
class ViecControllerCollections: UIViewController {
...
extension ViecControllerCollections: PinterestLayoutDelegate {
    func collectionView(_ collectionView: UICollectionView, heightForPhotoAtIndexPath indexPath: IndexPath) -> CGFloat {
        return dogs[indexPath.item].image.size.height
    }
}

extension ViecControllerCollections: UICollectionViewDelegateFlowLayout {
...
extension ViecControllerCollections: UICollectionViewDataSource {
