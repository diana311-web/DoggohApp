...
struct DogDataModel
{
    ...
    static func allDogs() -> [DogDataModel] {
        ...
        for dictionary in photosFromPlist {
            if let dog = DogDataModel(dictionary: dictionary) {
                dogs.append(dog)
            }
        }
        return dogs
...
extension DogDataModel: Equatable {
    static func ==(lhs: DogDataModel, rhs:DogDataModel) -> Bool {
